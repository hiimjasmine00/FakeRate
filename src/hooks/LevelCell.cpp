...
class $modify(FRLevelCell, LevelCell) {
    ...
    void loadFromLevel(GJGameLevel* level) {
        ...
        if (it == FakeRate::fakeRates.end()) return;
        ...
        auto showStars = fakeRateData.stars != 0 || dailyID > 0;
        ...
        if (showStars) {
            ...
            if (!starsIcon) {
                starsIcon = CCSprite::createWithSpriteFrameName(level->m_levelLength == 5 ? "moon_small01_001.png" : "star_small01_001.png");
            ...
            starsLabel->setString(fmt::to_string(fakeRateData.stars).c_str());
        ...
        auto mdo = fakeRateData.moreDifficultiesOverride;
        ...
        if (auto gddpIntegration = Loader::get()->getLoadedMod("minemaker0430.gddp_integration"); gddpIntegration && gio > 0 && gio < 17 &&
